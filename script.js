...
function generateBoard() {
  ...
  mineWindow.appendChild(generateMineToolbar());
...
function generateMineToolbar() {
  const mineToolbar = document.createElement("div");
  mineToolbar.id = "mineToolbar";
  mineToolbar.classList.add("mineToolbar");
  mineToolbar.innerHTML = `Minesweeper&nbsp;<i class="far fa-smile"></i>`;
  return mineToolbar;
}
